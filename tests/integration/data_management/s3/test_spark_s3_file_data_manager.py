...
from tests.common import build_spark_config, s3_bucket, use_temp_s3_folder
from tests.integration.data_management.base_test_data_manager import BaseTestDataManager


class TestIntegrationSparkS3FileDataManager(TestCase, BaseTestDataManager):
    @property
    def calculator_type(self):
        return lambda app: SparkCalculator(
            app, spark_config=build_spark_config(use_s3=True)
        )
