...
class TestIntegrationPolarsLocalFileDataManager(TestCase, BaseTestDataManager):
    @property
    ...
    def data_manager(self):
        return LocalFileDataManager(self.temp_directory)

    @use_temp_folder
    def test_save_and_load_no_partitioning(self):
        self._test_save_and_load(False)

    # Known failure: polars only supports dictionaries with string-like values
    # https://github.com/Ron-Ldn/nodalize/issues/1
    # @use_temp_folder
